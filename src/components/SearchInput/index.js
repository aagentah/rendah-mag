    ...
    return (
      <div className="searchInput">
        <form className="searchInput__form" action="#" onSubmit={this.submitForm}>
          ...
          <button className="searchInput__submit  cp" tyle="submit"><img className="di  searchInput__search-icon" width="50" src="https://res.cloudinary.com/dzz8ji5lj/image/upload/v1531174229/brand/util/iconmonstr-arrow-20-240_2.png" alt="Logo" role="presentation" /></button>
        </form>
        {this.redir()}
      </div>
    );
