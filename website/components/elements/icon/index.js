...
export const IconInstagram = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconSpotify = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconArrowLeft = ({ color, size }) => (
  <svg
    {...defaultProps({ color, size })}
    strokeLinejoin="round"
    strokeMiterlimit="2"
...
export const IconStar = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path
...
export const IconStore = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconSignIn = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path d="M8 10v-5l8 7-8 7v-5h-8v-4h8zm2-8v2h12v16h-12v2h14v-20h-14z" />
  </svg>
);

export const IconSignOut = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconAudio = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path d="M10.859 18.566l1.081-6.964 1.104 4.742c.109.486.784.541.968.073l1.001-2.557.934 2.176c.155.361.644.417.876.1l.85-1.156h1.837c.271 0 .49-.22.49-.49s-.22-.49-.49-.49h-2.099c-.162 0-.315.078-.41.208l-.472.611-1.071-2.496c-.179-.417-.773-.408-.939.016l-.848 2.168-1.308-6.102c-.123-.548-.907-.517-.996.03l-1.084 7-1.108-4.118c-.124-.492-.817-.52-.975-.032l-.825 2.715h-2.885c-.27 0-.49.22-.49.49s.22.49.49.49h3.284c.184 0 .382-.148.434-.324l.411-1.387 1.247 5.338c.135.537.905.501.993-.041zm11.141-12.566v16h-20v-16h20zm2-6h-24v24h24v-24z" />
  </svg>
);

export const IconNewspaper = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path d="M7 16h13v1h-13v-1zm13-3h-13v1h13v-1zm0-6h-5v1h5v-1zm0 3h-5v1h5v-1zm-17-8v17.199c0 .771-1 .771-1 0v-15.199h-2v15.98c0 1.115.905 2.02 2.02 2.02h19.958c1.117 0 2.022-.904 2.022-2.02v-17.98h-21zm19 17h-17v-15h17v15zm-9-12h-6v4h6v-4z" />
  </svg>
);

export const IconList = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path
...
export const IconMoney = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconWebLink = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconAt = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconHashtag = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconDownload = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path d="M12 21l-8-9h6v-12h4v12h6l-8 9zm9-1v2h-18v-2h-2v4h22v-4h-2z" />
  </svg>
);

export const IconPencil = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
...
export const IconInfoCircle = ({ color, size }) => (
  <svg {...defaultProps({ color, size })}>
    <path
