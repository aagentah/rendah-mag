...
```
now secrets add next_example_cms_sanity_preview_secret <SANITY_PREVIEW_SECRET>
now secrets add next_example_cms_sanity_api_token <SANITY_API_TOKEN>
now secrets add next_example_cms_sanity_project_id <SANITY_PROJECT_ID>
```
